            ...
            <div className="lg:col-span-2">
              <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl shadow-xl overflow-hidden">
                <div className="p-6 border-b">
                  <h2 className="text-2xl font-bold text-[#1e3a8a]">M.Sc Applied Mathematics</h2>
                  <p className="text-2xl font-bold text-[#1e3a8a]">Two Year Postgraduate Programme</p>
                </div>
                  ...
                  {activeTab === "selection" && (
                    <div className="space-y-6">
                      <div className="bg-[#1c3879]/5 rounded-xl p-6">
                        <h4 className="text-lg font-bold text-[#1c3879] mb-3">Equivalent Certificate from Tamil Nadu Government</h4>
                        <p className="text-gray-600 leading-relaxed">
