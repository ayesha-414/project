            ...
            <div className="lg:col-span-2">
              <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl shadow-xl overflow-hidden">
                <div className="p-6 border-b">
                  <h2 className="text-2xl font-bold text-[#1e3a8a]">B.Sc Applied Science</h2>
                  <p className="text-2xl font-bold text-[#1e3a8a]">Three Year Undergraduate Programme - Government Aided Programme</p>
                </div>
