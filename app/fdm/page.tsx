            ...
            <div className="lg:col-span-2">
              <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl shadow-xl overflow-hidden">
                ...
                <div className="flex flex-wrap gap-2 p-3 sm:p-4 bg-[#f7faff] border-b border-[#dce8f5]">
                  {[
                    ...
                    <button
                      ...
                      className={`flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg text-sm sm:text-base md:text-lg font-semibold transition-all ${
                        activeTab === tab.id
                ...
                <div className="p-4 sm:p-6">
                  {activeTab === "overview" && (
                    <div className="space-y-6">
                      <div>
                        ...
                        <div className="space-y-6">
                          <div className="text-base sm:text-lg md:text-xl text-gray-900 leading-relaxed mb-4 text-justify">
                            <div className="mt-5">
                      ...
                      <div>
                        ...
                        <p className="text-base sm:text-lg md:text-xl text-gray-900 leading-relaxed mb-4 text-justify">
                          ...
                          <span className="text-[#1e3a8a] text-xl sm:text-2xl font-bold">Educational Objectives:</span>
                        </p>
                        <div className="mt-6 sm:mt-8">
                          <div className="grid gap-4">
                            {objectives.map((obj, index) => (
                              ...
                              >
                                <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 text-[#1c3879] mt-1 flex-shrink-0" />
                                <p className="text-gray-900 text-base sm:text-lg md:text-xl">{obj}</p>
                              </div>
                            ))}
                          </div>
                        </div>
                      ...
                      <div className="pt-6 sm:pt-8 border-t border-gray-100">
                        <h4 className="text-xl sm:text-2xl font-bold text-[#1c3879] mb-4">Facilities</h4>
                        <p className="text-base sm:text-lg md:text-xl text-gray-900 leading-relaxed mb-5 sm:mb-6 text-justify">
                      ...
                      {/* Co-curricular */}
                      <div className="pt-6 sm:pt-8 border-t border-gray-100">
                        <h4 className="text-xl sm:text-2xl font-bold text-[#1c3879] mb-5 sm:mb-6">Co-curricular & Extra Curricular Activities</h4>
                          ...
                          >
                            ...
                            <ul className="space-y-2">
                              {subjects.map((subject, idx) => (
                                <li
                                  key={idx}
                                  className="text-[#334155] text-base sm:text-lg md:text-xl flex items-start gap-2 mb-3"
                                >
                  ...
                  {activeTab === "selection" && (
                    <div className="space-y-6">
                      <div className="bg-white p-4 sm:p-6 border rounded-xl shadow-sm">
                        ...
                        {alumni.map((alum, idx) => (
                          <div key={idx} className="program-card">
                            <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                              <div className="w-16 h-16 sm:w-24 sm:h-24 bg-[#1c3879] rounded-full flex items-center justify-center flex-shrink-0 overflow-hidden">
                                <img
                                  src={alum.image}
                                  alt={alum.name}
                              ...
                              <div>
                                <h5 className="text-xl sm:text-2xl font-bold text-[#1a1a2e]">{alum.name}</h5>
                                <p className="text-[#1c3879] text-base sm:text-lg font-medium">{alum.position}</p>
                                <p className="text-[#e8505b] text-base sm:text-lg">{alum.batch}</p>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white font-bold text-sm sm:text-lg">19th May 2026</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <Calendar className="w-5 h-5 text-[#e8505b] flex-shrink-0 mt-0.5" />
                    <div>
                      <p className="text-white/70 text-base sm:text-xl font-bold">Notification of shortlisted candidates for Counselling cum Admission in the campus</p>
                      <p className="text-white font-bold text-sm sm:text-lg">21st May 2026</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <Calendar className="w-5 h-5 text-[#e8505b] flex-shrink-0 mt-0.5" />
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white font-bold text-sm sm:text-lg">750 INR</p>
                    </div>
                  </li>
                </ul>
